...
/**
 * Simulates a Miner that performs a Proof of Work consensus mechanism transactions created in the
 * network. This is used for Unit testing, in a real blockchain network, miners would listen for
 * transactions nodes created and then perform POW and create a block, which would be sent back to
 * network, and validated by each node.
 */
public class Miner<T extends Transaction> {
